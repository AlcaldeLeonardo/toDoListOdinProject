...
export function toDocard(task) {
  ...
  cardBody.appendChild(
    paragraphDOM(
      spanWithLabelDOM("Priority", priority),
      "toDoCard__priority card__priority",
    ),
  );
  ...
  cardBody.appendChild(
    paragraphDOM(
      spanWithLabelDOM("Due Date", format(dueDate, "PPPP")),
      "toDoCard__dueDate card__dueDate",
    ),
  );
  ...
  card
    ...
    .addEventListener("click", () => taskCardDelBtnController(task));
